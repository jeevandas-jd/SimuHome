...
from src.pipelines.episode_generation.shared.selectors import list_devices_in_config


def build_qt3_feasible_payload(
    *,
    seed: int,
    ...
    seed = ensure_seed(seed, context="qt3 feasible payload")
    ...
    pool = list(list_devices_in_config(snapshot))
