...
from src.simulator.domain.clusters.identify import IdentifyCluster
...
class AirPurifier(Device):
    ...
    def __init__(self, device_id):
        ...
        self.add_cluster(1, DescriptorCluster())
        self.add_cluster(1, IdentifyCluster())
    ...
    def _check_power_dependency(self) -> Result:
        ...
        if not power_status:
            return Result.fail(
                ...
                "Cannot perform operation when power is OFF. Turn on the air purifier first.",
            )
        return Result.ok()
