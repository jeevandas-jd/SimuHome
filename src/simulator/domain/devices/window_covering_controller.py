...
from src.simulator.domain.clusters.window_covering import (
    WindowCoveringCluster,
)
from src.simulator.domain.result import Result, ResultBuilder, ErrorCode


class WindowCoveringController(Device):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            BasicInformationCluster(
                ...
                vendor_id=1,
                product_name="Window Covering Controller",
                product_id=10,
            ),
        )
        self.add_cluster(1, WindowCoveringCluster())
