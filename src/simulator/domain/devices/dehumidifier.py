...
class Dehumidifier(Device):
    ...
    def _check_power_dependency(self) -> Result:
        ...
        if not power_status:
            return Result.fail(
                ...
                "Cannot perform operation when power is OFF. Turn on the dehumidifier first.",
            )
        return Result.ok()
    ...
    def __str__(self):
        ...
        return (
            f"Dehumidifier(Power: {onoff_cluster.attributes.get('OnOff') if onoff_cluster else 'Unknown'}, "
